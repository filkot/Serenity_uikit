...
public class TableMappingSteps {
    ...
    @Alias("the user deselects row with column '$columnName' and value '$columnName' in <tableCaption> table")
    ...
    public void thenTheyShouldSeeCheckedItemInSettingsWheel(String item, String tableCaption) {
    ...
    public void thenTheyShouldSeeUncheckedItemInSettingsWheel(String item, String tableCaption) {
