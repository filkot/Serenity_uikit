...
Given the user refresh the Example page
When the user select 'Trees and Tables->Tree' in tree
And the user select 'child 1->child 2' in tree
And the user select 'child 1' in tree
And the user select 'child 4->child 5' in tree
And the user select 'child 4' in tree
Then the user should not see tree sub item with name '$sub_item' for '$item'
...
And the user select 'child 1->child 2' in tree
And the user select 'child 1' in tree
And the user select 'child 1->child 3' in tree
And the user select 'child 1' in tree
And the user select 'child 4->child 5' in tree
And the user select 'child 4' in tree
And the user select 'child 4->child 6' in tree
And the user select 'child 4' in tree
Then the user should not see tree sub item with name '$sub_item' for '$item'
...
And the user select 'child 4' in tree
And the user select 'child 4->child 6' in tree
And the user select 'child 7->child 8' in tree
And the user select 'child 7' in tree
And the user select 'child 7->child 9' in tree
And the user select 'child 10->child 11' in tree
And the user select 'child 10' in tree
And the user select 'child 10->child 12' in tree
And the user select 'child 1' in tree
And the user select 'child 4' in tree
And the user select 'child 7' in tree
And the user select 'child 10' in tree
