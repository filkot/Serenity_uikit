...
And the user makes not visible column 'Description' from the wheel for <tableCaption> table
...
And they should see unchecked 'Password' item in the wheel in <tableCaption> table
And they should see unchecked 'Date' item in the wheel in <tableCaption> table
And they should see unchecked 'Active' item in the wheel in <tableCaption> table
And they should see unchecked 'Description' item in the wheel in <tableCaption> table
Examples:
|tableCaption|
...
And they should see checked 'Password' item in the wheel in <tableCaption> table
And they should see checked 'Date' item in the wheel in <tableCaption> table
And they should see checked 'Active' item in the wheel in <tableCaption> table
And they should see unchecked 'Description' item in the wheel in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
And they should see checked 'Date' item in the wheel in <tableCaption> table
And they should see checked 'Active' item in the wheel in <tableCaption> table
And they should see checked 'Description' item in the wheel in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '49' is selected in <tableCaption> table
And they should see row with column 'Id' and value '48' is deselected in <tableCaption> table
And they should see <tableCaption> table in not scrolled to the beggining
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '1' is selected in <tableCaption> table
And they should see row with column 'Id' and value '2' is selected in <tableCaption> table
And they should see row with column 'Id' and value '3' is selected in <tableCaption> table
And they should see row with column 'Id' and value '4' is selected in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '48' is selected in <tableCaption> table
And they should see row with column 'Id' and value '49' is selected in <tableCaption> table
And  they should see <tableCaption> table in not scrolled to the beggining
...
Then they should see row with column 'Id' and value '46' is selected in <tableCaption> table
And they should see row with column 'Id' and value '47' is selected in <tableCaption> table
And they should see row with column 'Id' and value '48' is selected in <tableCaption> table
And they should see row with column 'Id' and value '49' is selected in <tableCaption> table
And they should see <tableCaption> table in not scrolled to the beggining
Examples:
...
And the user multi-selects row with column 'Id' and value '4' in <tableCaption> table
Then they should see row with column 'Id' and value '3' is selected in <tableCaption> table
And they should see row with column 'Id' and value '4' is selected in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '1' is selected in <tableCaption> table
And they should see date '4/10/16 05:12:17 PM' in column 'Date' for row with column 'Id' and value '1' in <tableCaption> table
And they should see date '3/11/16 08:35:36 PM' in column 'Date' for row with column 'Id' and value '2' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '1' is selected in <tableCaption> table
And they should see row with column 'Id' and value '2' is selected in <tableCaption> table
And they should see date '3/10/16 08:32:56 PM' in column 'Date' for row with column 'Id' and value '1' in <tableCaption> table
And they should see date '4/10/16 05:12:17 PM' in column 'Date' for row with column 'Id' and value '2' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '1' is selected in <tableCaption> table
And they should see unselected checkbox in column 'Active' for row with column 'Id' and value '1' in <tableCaption> table
And they should see selected checkbox in column 'Active' for row with column 'Id' and value '2' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '1' is selected in <tableCaption> table
And they should see row with column 'Id' and value '2' is selected in <tableCaption> table
And they should see selected checkbox in column 'Active' for row with column 'Id' and value '1' in <tableCaption> table
And they should see unselected checkbox in column 'Active' for row with column 'Id' and value '2' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '1' is selected in <tableCaption> table
And they should see text 'New description' in column 'Description' for row with column 'Id' and value '1' in <tableCaption> table
And they should see text 'Description of user2' in column 'Description' for row with column 'Id' and value '2' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
Then they should see row with column 'Id' and value '1' is selected in <tableCaption> table
And they should see row with column 'Id' and value '2' is selected in <tableCaption> table
And they should see text 'Description of user1' in column 'Description' for row with column 'Id' and value '1' in <tableCaption> table
And they should see text 'New description' in column 'Description' for row with column 'Id' and value '2' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
When the user select 'Trees and Tables->Table' in tree
And the user multi-selects row with column 'Id' and value '4' in <tableCaption> table
Then they should see row with column 'Id' and value '4' is selected in <tableCaption> table
When the user multi-selects row with column 'Id' and value '6' in <tableCaption> table
Then they should see row with column 'Id' and value '4' is selected in <tableCaption> table
And they should see row with column 'Id' and value '5' is unselected in <tableCaption> table
And they should see row with column 'Id' and value '6' is selected in <tableCaption> table
And they should see row with column 'Id' and value '7' is unselected in <tableCaption> table
...
And they should see row with column 'Id' and value '2' is selected in <tableCaption> table
And they should see row with column 'Id' and value '3' is unselected in <tableCaption> table
And they should see row with column 'Id' and value '4' is selected in <tableCaption> table
And they should see row with column 'Id' and value '5' is unselected in <tableCaption> table
And they should see row with column 'Id' and value '6' is selected in <tableCaption> table
And they should see row with column 'Id' and value '7' is unselected in <tableCaption> table
...
And they should see selected checkbox in column 'Active' for row with column 'Id' and value '2' in <tableCaption> table
And they should see row with column 'Id' and value '4' is selected in <tableCaption> table
And they should see unselected checkbox in column 'Active' for row with column 'Id' and value '4' in <tableCaption> table
And they should see row with column 'Id' and value '6' is selected in <tableCaption> table
And they should see selected checkbox in column 'Active' for row with column 'Id' and value '6' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
And they should see selected checkbox in column 'Active' for row with column 'Id' and value '2' in <tableCaption> table
And they should see row with column 'Id' and value '4' is selected in <tableCaption> table
And they should see selected checkbox in column 'Active' for row with column 'Id' and value '4' in <tableCaption> table
And they should see row with column 'Id' and value '6' is selected in <tableCaption> table
And they should see selected checkbox in column 'Active' for row with column 'Id' and value '6' in <tableCaption> table
Examples:
|tableCaption|
...
Then they should see row with column 'Id' and value '2' is selected in <tableCaption> table
And they should see date '3/14/16 12:52:38 PM' in column 'Date' for row with column 'Id' and value '2' in <tableCaption> table
And they should see row with column 'Id' and value '4' is selected in <tableCaption> table
And they should see date '4/10/16 05:12:17 PM' in column 'Date' for row with column 'Id' and value '4' in <tableCaption> table
And they should see row with column 'Id' and value '6' is selected in <tableCaption> table
And they should see date '3/18/16 12:52:38 PM' in column 'Date' for row with column 'Id' and value '6' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|
...
And they should see text 'Description of user2' in column 'Description' for row with column 'Id' and value '2' in <tableCaption> table
And they should see row with column 'Id' and value '4' is selected in <tableCaption> table
And they should see text 'New description' in column 'Description' for row with column 'Id' and value '4' in <tableCaption> table
And they should see row with column 'Id' and value '6' is selected in <tableCaption> table
And they should see text 'Description of user6' in column 'Description' for row with column 'Id' and value '6' in <tableCaption> table
Examples:
|tableCaption|
|Table with different components in columns and multi selection mode|