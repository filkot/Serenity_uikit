...
And the user makes 'Description' column not visible from the settings wheel for <tableCaption> table
And the user makes 'Active' column not visible from the settings wheel for <tableCaption> table
...
And the user should not see 'Active' column in <tableCaption> table
And the user should not see 'Description' column in <tableCaption> table
...
And the user should see 'Active' column in <tableCaption> table
And the user should not see 'Description' column in <tableCaption> table
...
And the user should see 'Date' column in <tableCaption> table
And the user should see 'Active' column in <tableCaption> table
And the user should see 'Description' column in <tableCaption> table
And the user should see that 'Id' item is checked in the settings wheel in <tableCaption> table
And the user should see that 'Name' item is checked in the settings wheel in <tableCaption> table
