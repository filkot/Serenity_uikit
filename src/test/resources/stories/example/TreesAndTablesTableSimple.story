...
When the user select 'Trees and Tables->Table' in tree
And the user makes visible column 'Id' from the settings wheel for <tableCaption> table
...
When the user makes visible column 'Name' from the settings wheel for <tableCaption> table
...
When the user makes visible column 'Id' from the settings wheel for <tableCaption> table
And the user makes visible column 'Name' from the settings wheel for <tableCaption> table
Then they should see column 'Id' in <tableCaption> table
...
Scenario: Make not visible columns 'id' and 'name' from the settings wheel for SIMPLE table
When the user makes not visible column 'Id' from the settings wheel for <tableCaption> table
And  the user makes not visible column 'Name' from the settings wheel for <tableCaption> table
Then they should not see column 'Id' in <tableCaption> table
And they should not see column 'Name' in <tableCaption> table
...
And they should see the label with text 'user1'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
Then they should see row with column 'Id' and value '0' is selected in <tableCaption> table
And they should see the label with text 'ALL'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
And they should see the label with text 'user49'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
And they should see the label with text 'ALL'
And they should see <tableCaption> table is not scrolled to the beggining
...
And they should see the label with text 'user2'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
And they should see the label with text 'user48'
Examples:
|tableCaption|
|Simple Table with label components as columns|
