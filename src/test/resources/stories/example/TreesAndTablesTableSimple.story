...
And the user selects the checkbox with caption 'id'
Then the user should see the column 'Id' in the table
And the user should not see the column 'Name' in the table

Scenario: Uncheck the checkbox with caption 'id' only for SIMPLE table
When the user deselects the checkbox with caption 'id'
Then the user should not see the column 'Id' in the table
And the user should not see the column 'Name' in the table

Scenario: Check the checkbox with caption 'name' only for SIMPLE table
When the user selects the checkbox with caption 'name'
Then the user should see the column 'Name' in the table
And the user should not see the column 'Id' in the table

Scenario: Uncheck the checkbox with caption 'name' only for SIMPLE table
When the user deselects the checkbox with caption 'name'
Then the user should not see the column 'Name' in the table
And the user should not see the column 'Id' in the table

Scenario: Check the checkbox with caption 'id' and 'name' for SIMPLE table
When the user selects the checkbox with caption 'id'
And the user selects the checkbox with caption 'name'
Then the user should see the column 'Id' in the table
And the user should see the column 'Name' in the table

Scenario: Uncheck the checkbox with caption 'id' and 'name' for SIMPLE table
When the user deselects the checkbox with caption 'id'
And the user deselects the checkbox with caption 'name'
Then the user should not see the column 'Id' in the table
And the user should not see the column 'Name' in the table
...
When the user selects the item 'Trees and Tables->Table' in a tree
And the user makes the column 'Id' visible from the settings wheel for <tableCaption> table
Then the user should see the column 'Id' in <tableCaption> table
And the user should not see the column 'Name' in <tableCaption> table
And the user should see that item 'Id' is checked in the settings wheel in <tableCaption> table
And the user should see that item 'Name' is unchecked in the settings wheel in <tableCaption> table
Examples:
|tableCaption|
...
When the user makes the column 'Id' not visible from the settings wheel for <tableCaption> table
Then the user should not see the column 'Id' in <tableCaption> table
And the user should not see the column 'Name' in <tableCaption> table
And the user should see that item 'Id' is unchecked in the settings wheel in <tableCaption> table
And the user should see that item 'Name' is unchecked in the settings wheel in <tableCaption> table
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
When the user makes the column 'Name' visible from the settings wheel for <tableCaption> table
Then the user should see the column 'Name' in <tableCaption> table
And the user should not see the column 'Id' in <tableCaption> table
And the user should see that item 'Id' is unchecked in the settings wheel in <tableCaption> table
And the user should see that item 'Name' is checked in the settings wheel in <tableCaption> table
Examples:
|tableCaption|
|Simple Table with label components as columns|

Scenario: Make visible columns 'id' and 'name' from the settings wheel for SIMPLE table
When the user makes the column 'Id' visible from the settings wheel for <tableCaption> table
And the user makes the column 'Name' visible from the settings wheel for <tableCaption> table
Then the user should see the column 'Id' in <tableCaption> table
And the user should see the column 'Name' in <tableCaption> table
And the user should see that item 'Id' is checked in the settings wheel in <tableCaption> table
And the user should see that item 'Name' is checked in the settings wheel in <tableCaption> table
Examples:
|tableCaption|
...
Scenario: Make not visible columns 'id' and 'name' from the settings wheel for SIMPLE table
When the user makes the column 'Id' unseen from the settings wheel for <tableCaption> table
And  the user makes the column 'Name' unseen from the settings wheel for <tableCaption> table
Then the user should not see the column 'Id' in <tableCaption> table
And the user should not see the column 'Name' in <tableCaption> table
And the user should see that item 'Id' is checked in the settings wheel in <tableCaption> table
And the user should see that item 'Name' is checked in the settings wheel in <tableCaption> table
...
Given the user refresh the Example page
When the user selects the item 'Trees and Tables->Table' in a tree
And the user selects the row with column 'Id' and value '0' in <tableCaption> table
Then the user should see that row with column 'Id' and value '0' is selected in <tableCaption> table
And the user should see the label with text 'user1'
Examples:
|tableCaption|
|Simple Table with label components as columns|

Scenario: Deselect the first column in SIMPLE table
When the user deselects the row with column 'Id' and value '0' in <tableCaption> table
Then the user should see that row with column 'Id' and value '0' is selected in <tableCaption> table
And the user should see the label with text 'ALL'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
Given the user refresh the Example page
When the user selects the item 'Trees and Tables->Table' in a tree
And the user vertical scroll down to the end in <tableCaption> table
...
And the user should see the label with text 'user49'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
And the user should see the label with text 'ALL'
And the user should see <tableCaption> table is not scrolled to the beggining
...
And the user should see the label with text 'user2'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
And the user should see the label with text 'user48'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
And the user vertical scroll down to the end in <tableCaption> table
And the user selects row with column 'Id' and value '48' in <tableCaption> table
And the user vertical scroll up to the beginning in <tableCaption> table
And the user selects row with column 'Id' and value '1' in <tableCaption> table
Then the user should see row with column 'Id' and value '1' is selected in <tableCaption> table
And the user should see the label with text 'user1'
...
Scenario: Selection is not disabling for a row when another column is visible in SIMPLE table
When the user makes not visible column 'Name' from the settings wheel for <tableCaption> table
Then the user should see row with column 'Id' and value '1' is selected in <tableCaption> table
And the user should see the label with text 'user1'
Examples:
|tableCaption|
...
When the user makes not visible column 'Id' from the settings wheel for <tableCaption> table
...
Then the user should see row with column 'Id' and value '1' is selected in <tableCaption> table
And the user should see checkbox for row with column 'Id' and value '1' is selected in <tableCaption> table
And the user should see the label with text 'user1'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
And  the user should see checkbox for row with column 'Id' and value '1' is unselected in <tableCaption> table
And the user should see the label with text 'ALL'
Examples:
|tableCaption|
|Simple Table with label components as columns|
...
And the user should see row with column 'Id' and value '1' is unselected in <tableCaption> table
And the user should see checkbox for row with column 'Id' and value '2' is selected in <tableCaption> table
And the user should see checkbox for row with column 'Id' and value '1' is unselected in <tableCaption> table
And the user should see the label with text 'user2'
Examples:
|tableCaption|
