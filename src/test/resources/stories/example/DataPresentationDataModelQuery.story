...
*
* UI element: DataPresentation -> DataModelQuery (1.29)
*-----------------------------------------------------------------------------------------------------------------------

Meta: @group: DataModel
...
When the user selects the item 'Data Presentation->DataModel Query' in a tree
...
When the user click button with name 'Query Instance'
Then they should see all data in a table
!-- or some error? TO DO: clarification is required
