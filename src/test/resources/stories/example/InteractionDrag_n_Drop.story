...
When the user select 'Interaction->Drag'n'Drop' in tree
And the user drags and drops the row '$row_number' from table '$table_name1' to table '$table_name2'
Then they should see new row '$row_number' in table '$table_name2'
...
Then they should not see the row '$row_number' in table '$table_name2'
...
Then they should see new rows '$row_list' in table '$table_name2'
...
And the user drags and drops the row '$row_number' from table '$table_name1' to table '$table_name2'
And the user drags and drops the row '$row_number' from table '$table_name1' to table '$table_name2'
Then they should see '$n' new rows '$row_number' in table '$table_name2'
